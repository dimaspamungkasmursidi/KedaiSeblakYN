      ...
      <div className="flex flex-col md:flex-row justify-between px-6 gap-6">
        ...
        <div className="flex flex-col md:flex-row items-start gap-2">
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm w-[15rem]">Srigading, Timur Pom Plosokandang, Kec. Kedungwaru, Kab. Tulungagung, Jawa Timur, 66229.</p>
          </div>
        ...
        <div className="flex flex-col items-start">
          <h3 className="text-2xl font-londrina tracking-wider mb-2">Navigasi</h3>
        ...
        {/* Contact Info */}
        <div className="flex flex-col items-start">
          <h3 className="text-2xl font-londrina tracking-wider mb-2">Web Developer</h3>
          <p className="text-sm mb-2">Website dibuat oleh Dimas Pamungkas Mursidi</p>
          <div className="flex space-x-4">
            <a
